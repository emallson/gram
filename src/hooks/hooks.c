...
static void init_gram_key_hooks(void* ignore) {
  gram_keydown_hook_init ();
}

static void init_gram_view_hooks(void* ignore) {
...
static void init_gram_output_hooks(void* ignore) {
...
static void init_gram_pointer_hooks(void* ignore) {
  gram_pointer_motion_hook_init();
}

static void init_gram_compositor_hooks(void* ignore) {
...
init_gram_hooks (void)
{
  ...
  scm_c_define_module("gram compositor hooks", init_gram_compositor_hooks, NULL);
}
